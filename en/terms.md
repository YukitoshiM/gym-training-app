...
These terms apply to the BodyMode app, Apple Watch features, widget, and related services. By using BodyMode, you agree to these terms.

## 2. Features

BodyMode helps you record, display, and analyze body measurements, meals, photos, workouts, activity, sleep, condition, and related information. Features may change to improve quality or meet legal and platform requirements.

## 3. Health and Medical Notice

BodyMode is not a medical device and does not provide diagnosis, treatment, disease prevention, or emergency response. Values, analyses, alerts, and recommendations are reference information. Consult a qualified healthcare professional if you have health concerns.

## 4. AI Output

AI estimates of meal amounts or nutrition, photo comparisons, workout recommendations, chat responses, and weekly or monthly comments may be inaccurate. Food-composition values are also standard reference values and may differ from a particular product or preparation method. You are responsible for reviewing, correcting, and deciding whether to use AI output, proposed monthly goals, and memory candidates. BodyMode does not claim to determine body-fat percentage or health status from photos alone.

## 5. Apple Health and Sensor Data

Data obtained from Apple Health or Apple Watch may contain measurement errors or gaps. Do not use it for medical decisions, emergency decisions, or as the sole safety check for potentially hazardous exercise.

## 6. Your Responsibilities

You are responsible for considering your condition, experience, equipment, and surroundings and for using BodyMode within an appropriate range. You are also responsible for your device, Apple ID, AI server settings, and record data.

## 7. Prohibited Conduct

You may not violate laws or public policy; analyze, disrupt, or misuse the service; infringe third-party rights; use false information to harm others; or interfere with operation of the service.

## 8. Storage and Backup

The initial release stores most records on your device. Protect important records by using the export feature or another appropriate method in case the device is lost or damaged or the app is deleted.
