...
MVP後は、競合アプリの主要機能も参考にしながら以下の順で拡張すると価値がつながりやすい。

1. V1: 前回履歴表示、前回値コピー、種目別履歴、週次ボリューム
2. V1: セット間タイマー、種目別休憩時間、RM自動計算
3. V1: RPE/RIR、未達理由、次回目標提案
4. V1: Apple Health連携、CSV出力、記録忘れ通知
5. V1: 種目お気に入り、別名統合、メニュー複製
6. V2: AI重量提案、停滞検知、代替種目提案
7. V2: Apple Watch、Live Activities、ウィジェット
8. V2: 写真比較、SNS共有
