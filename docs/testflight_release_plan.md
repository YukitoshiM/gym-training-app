...
| TF-11 | P0 | 完了 | バージョンとビルド番号を更新 | `0.1.0 (11)`へ更新済み |
...
| TF-15 | P0 | 完了 | 配布用アーカイブをアップロード | Build 11がApp Store Connectで`VALID`になっている |
| TF-16 | P0 | 進行中 | TestFlightで受入確認 | iPhoneとWatchへインストールし、Build 11の主要フローを一周できる |
| TF-17 | P0 | 完了 | 外部TestFlight審査へ提出 | Build 11が外部グループで`IN_BETA_TESTING`になっている |
